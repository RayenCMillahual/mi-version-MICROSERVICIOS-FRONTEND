...
async function bootstrap() {
  ...
  // ✅ CORS CORREGIDO - Restrictivo en producción
  const isProduction = process.env.NODE_ENV === 'production';
  
  app.enableCors({
    origin: isProduction 
      ? [envs.frontendUrl] // Solo frontend en producción
      : true, // Todos en desarrollo
  ...
  console.log(`🔐 CORS enabled for: ${isProduction ? envs.frontendUrl : 'ALL origins (development)'}`);
